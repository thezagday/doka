...
<div class="login">
    <div class="login-body">
        ...
        <div class="login-form">
            <form data-toggle="md-validator" method="post" action="login" role="form">
                {{ csrf_field() }}

                <div class="md-form-group md-label-floating ">
                    <input class="md-form-control " type="text" name="login" spellcheck="false" autocomplete="off" data-msg-required="Please enter your email address."  value="{{ old('email') }}">
